class Play extends Phaser.Scene {
    ...
    create(){
        ...
        var fishphys = this.physics.add.image(game.config.width * 0.05, game.config.height/2, 'pfish')
        ...
        var sharkphys = this.physics.add.image(game.config.width * 0.05, game.config.height/2, 'shark')
        ...
        this.physics.moveToObject(sharkphys, fishphys, 240);
